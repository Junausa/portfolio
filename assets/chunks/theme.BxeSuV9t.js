import{d as g,u as k,c,o,n as v,a as t,b as d,e as i,w as u,t as h,_ as b,F as $,h as _,f,g as C,i as M,r as V}from"./framework.BVP8IbOo.js";const B=["src"],I={class:"text-container"},j=["src"],z={class:"column"},N=["src"],P={key:2},T={key:3},D={key:4},H=g({__name:"Header",setup(r){const{site:a,frontmatter:e}=k();return(n,m)=>(o(),c("header",{id:"header-wrapper",class:v({large:t(e).headerIsLarge})},[t(e).headerImg?(o(),c("img",{key:0,class:"bg-img",src:t(u)(t(e).headerImg)},null,8,B)):d("",!0),i("div",I,[t(e).headerPfp?(o(),c("img",{key:0,class:"pfp",src:t(u)(t(e).headerPfp)},null,8,j)):d("",!0),i("div",z,[t(e).logo?(o(),c("img",{key:0,src:t(u)(t(e).logo)},null,8,N)):d("",!0),t(e).header1?(o(),c("h1",{key:1,class:v({"sr-only":t(e).logo})},h(t(e).header1),3)):d("",!0),t(e).header1&&(t(e).header2||t(e).header3)?(o(),c("hr",P)):d("",!0),t(e).header2?(o(),c("h2",T,h(t(e).header2),1)):d("",!0),t(e).header3?(o(),c("div",D,h(t(e).header3),1)):d("",!0)])])],2))}}),q=b(H,[["__scopeId","data-v-bfacdba6"]]),R={id:"top-nav"},U=["href"],F={class:"hide-mobile"},Z=g({__name:"Nav",setup(r){const{site:a,page:e,frontmatter:n}=k();return(m,s)=>(o(),c("nav",R,[i("a",{href:t(u)("/"),class:"nav-link"},[i("div",null,h(t(a).title),1)],8,U),t(e).title?(o(),c($,{key:0},[s[0]||(s[0]=i("div",{class:"divider hide-mobile"},null,-1)),i("div",F,h(t(e).title),1)],64)):d("",!0)]))}}),E=b(Z,[["__scopeId","data-v-8ac9b9ce"]]);/**
